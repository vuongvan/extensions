            ...
            if (match != null) {
                ...
                callback.invoke(
                    newExtractorLink(
                        ...
                        url = m3u8Url
                    ) { // Dấu ngoặc nhọn bắt đầu ở đây
                        this.referer = "https://www.dailymotion.com/"
                        // Lưu ý: Không dùng dấu "=" nếu bị lỗi val, hãy dùng hàm setter nếu có 
                        // Nhưng thông thường trong DSL của Cloudstream là gán trực tiếp:
                    }
                )
                return true
            }
